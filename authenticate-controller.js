...
function doctor(user_id){
		connection.query('select doctor_id from doctor where user_id_ref=?',[user_id],function(errord,resultsd,fieldsd){
					if(errord){
						return;
					/*res.json({
				status:false,
